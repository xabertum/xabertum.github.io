...
<div class="section scrollspy" id="work">
	       ...
	       <div class="col s12 m4 l4">
               <div class="card">
                  ...
                  <div class="card-reveal">
					...
					<center><a href="https://play.google.com/store/apps/details?id=es.xabertum.weatheron"><img src="img/google-play-icon.png" width="245" alt=""/></a></center>
                  </div>
              </div>
          </div>
 ...
 <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul id="socialIcons">
            <li><a class="white-text" href="https://github.com/xabertum"><img id="github" src="img/github100.png" width="30" height="29" alt=""/></a></li>
            <li><a class="white-text" href="https://twitter.com/xabertum"><img id="twitter" src="img/twitter100.png" width="30" height="30" alt=""/></a></li><br/>
            <li><a class="white-text" href="https://plus.google.com/102691326819028507880/posts"><img id="google" src="img/google+100.png" width="30" height="30" alt=""/></a></li>
            <li><a class="white-text" href="es.linkedin.com/in/xabertum"><img id="linkedin" src="img/linkedin100.png" width="30" height="30" alt=""/></a></li>
