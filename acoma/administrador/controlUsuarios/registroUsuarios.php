...
<tr>
    <td colspan="2">Gracias por tu interes en registrarte. Para hacerlo, solo debes rellenar
    los siguientes campos y pulsar el boton <b>Registrarme</b>. Tu cuenta se activara y podras acceder
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="rad_TipoUsuario" id="rad_TipoUsuario" disabled value="2" checked="checked"  /> Asociado 
        </td>
    </tr>
...
<tr>
    ...
    <td align="center" colspan="2">
        <br /><br />
        <input type="button" onClick="javascript: parent.window.location.href='../../index.php'" name="cancelar" value="Cancelar" >
        &nbsp;&nbsp;&nbsp;&nbsp;
