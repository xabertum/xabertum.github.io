<?php
    ...
    $i_TipoUsuario  =trim($_POST['rad_TipoUsuario']);
    ...
    ?>
    <form id="frm_error"   name="frm_error" method="post" action="registroUsuariosAdmin.php">
...
'".date("Y-m-d H:i:s")."');";
    ...
    ?>
    <form id="frm_registro_status"   name="frm_registro_status" method="post" action="javascript: parent.parent.window.location.href='../index.php?sr=1'">
    </form>
    <script type="text/javascript">
        //Redireccionar con el formulario creado
