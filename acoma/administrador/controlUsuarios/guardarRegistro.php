<?php
    ...
    ?>
    <form id="frm_error"   name="frm_error" method="post" action="registroUsuarios.php">
...
'".date("Y-m-d H:i:s")."');";
    ...
    ?>
    <form id="frm_registro_status"   name="frm_registro_status" method="post" action="javascript: parent.window.location.href='../../index.php?sr=1'">
    </form>
    <script type="text/javascript">
        //Redireccionar con el formulario creado
