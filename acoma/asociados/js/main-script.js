...
$('document').ready(function(){
    $("#contacto_button").click(function() {
        ...
        if(nombre =="") {
			...
			jQuery.post( "enviarContactoForm.php", {
				nombre:nombre,
				email:emailForm,
				asunto:asunto,
				mensaje:mensaje },
...
$(document).ready(function() {
	         ...
	         $("#mainNoticias").mouseover(function() { 
               $(this).attr("src", "images/app_type_newspaper_512px_COLOR.png");
            });

            $("#mainNoticias").mouseout(function() { 
               $(this).attr("src", "images/app_type_newspaper_512px_BLANCO.png");
            });

			$("#mainGaleria").mouseover(function() {
               $(this).attr("src", "images/gallery-iconColor.png");
            });

			
			$("#mainGaleria").mouseout(function() {
               $(this).attr("src", "images/gallery-iconBlanco.png");
            });
